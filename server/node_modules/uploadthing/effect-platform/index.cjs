...
const createRouteHandler = (opts)=>{
    ...
    return platform.HttpRouter.provideServiceEffect(router, MiddlewareArguments, Effect__namespace.map(platform.HttpServerRequest.HttpServerRequest, (serverRequest)=>({
            req: serverRequest,
            res: undefined,
            event: undefined
