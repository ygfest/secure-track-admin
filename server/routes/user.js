...
router.get('/verify', verifyUser, async (req, res) => {
  try {
    ...
    return res.json({ status: true, message: "Authorized", user: { firstname: user.firstname, email: user.email, lastname: user.lastname, userID: user._id, latitude: user.latitude, longitude: user.longitude, profile_dp: user.profile_dp, logggedInAt: user.loggedInAt } });
  } catch (error) {
