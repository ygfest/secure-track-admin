...
const NavigationBar = () => {
  ...
  return (
    <>
      <div className="navbar-container bg-base-100 h-16 z-30 shadow-sm relative bordered">
      ...
      {openNotif && (
        <div className="fixed top-16 right-2 w-[72%] sm:w-96 bg-white shadow-lg rounded-lg z-[25] p-4 border border-gray-300">
